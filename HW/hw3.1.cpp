...
public:
    ...
    Queue(const Queue& other) : _buffer_size(other._buffer_size), _real_size(other._real_size),
        _tail(other._tail), _head(other._head) {
...
private:
    void grow();
    std::size_t size() { return _buffer_size; }
    T* buf() { return _buffer; }
